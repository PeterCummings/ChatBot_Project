...
knowledge_base = {
    ...
    "Plan2Peak services": "Plan2Peak offers personalized health and performance coaching for athletes, patients, and healthcare providers. Services include exercise prescription, metabolic health coaching, remote therapeutic monitoring, and athlete training plans tailored to individual goals.",
    ...
    "Payment options": "Plan2Peak services are eligible for payment through Health Savings Accounts (HSA) and Flexible Spending Accounts (FSA). This makes it more accessible and affordable for individuals looking to invest in their health and performance.",
    ...
    "Remote health programs": "Plan2Peak’s remote health programs deliver personalized coaching and monitoring directly to clients through secure online platforms. This includes custom exercise prescriptions, nutrition guidance, as well as health and lifestyle coaching.",
    ...
    "Remote health program cost": "Plan2Peak's remote health program, named the Get Healthy Program, is $359/month and is HSA and FSA eligible.",
    "Performance coaching plans": "Plan2Peak offers four levels of coaching plans with varying features: Level 1 includes monthly consultations ($249/month), Level 2 includes biweekly consultations ($329/month), Level 3 includes weekly consultations ($359/month), and Level 4 includes unlimited consultations ($499/month).",
    "Client outcomes": "Plan2Peak clients experience measurable outcomes, such as improved cardiorespiratory fitness, successful disease management, and optimized athletic performance.",
